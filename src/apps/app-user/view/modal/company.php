            ...
            <form id="companyForm" class="form-horizontal">
                ...
                <?php if ($type == 'company'): ?>
                    ...
                    <div class="col-12">
                        ...
                        <?php endif; ?>
                        <button type="button" class="btn btn-sm btn-secondary px-3 shadow-none <?= (isset($company_id) && !empty($company_id)) ? '' : 'col-12' ?>" style="border-radius: 11px;" onclick="postCheck('company_err', $('#companyForm').serialize(), 0, true)" <?= ((!$is_admin || !$subscription) ? '' : '') ?>> <?= (($company != null) ? 'Edit' : 'Add') ?> Company </button>
                    </div>
