    ...
    <div class="row">
        ...
        <div class="col-12" id="form_member">
            ...
            <form id="assignForm" class="form-horizontal">
                ...
                <div class="col-12">
                    <button type="button" class="btn btn-sm btn-secondary px-3 shadow-none col-12" style="border-radius: 11px;" onclick="postCheck('assign_message', $('#assignForm').serialize(), 0, true)" <?= ((!$is_admin || !$subscription) ? 'disabled' : '') ?>> Assign </button>
                </div>
            </form>
        </div>
