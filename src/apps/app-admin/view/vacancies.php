                                    ...
                                    <?php foreach ($careers_data as $career) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary font-weight-bold text-xs" onclick="requestModal(post_modal[16], post_modal[16], {'career':<?= $career['application_id'] ?>, 'type':'vacancy'})" <?= ((!$is_admin || !$subscription) ? 'disabled' : '') ?>>
                                                    Edit
                                                </a>
                                            </td>
                                        </tr>
