<div class="container">
    <div class="row">
        ...
        <div class="col-12">
            <a class="btn btn-sm btn-secondary px-3 border-radius-lg" <?= ((!$is_admin) ? 'disabled' : 'href="task" type="button"') ?>> Add Task </a>
            <button class="btn btn-sm btn-warning border-radius-lg px-3" type="button" onclick="requestModal(post_modal[17], post_modal[17], {'user_type':'guest'})" <?= ((!$is_admin) ? 'disabled' : '') ?>> Manage Task Categories </button>
            <div class="col">
