        ...
        <div class="col-12">
         ...
         <div class="col-12">
            <div class="input-group mb-2">
                ...
                <input type="text" class="form-control shadow-none" name="event_occupation" value="<?= (isset($event['event_occupation'])) ? $event['event_occupation'] : '' ?>" placeholder="Company name">
            </div>
        </div>
