...
<div class="card-body p-3">
    ...
    <form id="<?= $b_form_usr ?>" class="form-row align-items-center">
        ...
        <div class="col-12">
            <div class="input-group mb-2">
                <span class="input-group-text text-warning" style="border-right: none;"> <i class="fa-solid fa-location-dot input_color"></i> </span>
                <input type="text" class="form-control shadow-none" name="event_town" value="<?=(isset($event['event_town'])) ? $event['event_town'] : '' ?>" placeholder="Town">
            </div>
        </div>
        ...
        <div class="col-12 mb-3">
            <div class="input-group mb-2">
                <span class="input-group-text text-warning" style="border-right: none;"> <i class="fa-solid fa-location-dot input_color"></i> </span>
                <input type="text" class="form-control shadow-none" name="event_city" value="<?=(isset($event['event_city'])) ? $event['event_city'] : '' ?>" placeholder="City">
            </div>
        </div>

        <div class="col-12">
            <label for=""> Select Coutry </label>
            <div class="input-group mb-2">
                <span class="input-group-text text-warning" style="border-right: none;"><i class="fa-sharp fa-solid fa-flag input_color"></i> </span>
