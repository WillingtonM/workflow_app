...
//     header("Expires: Wed, 1 Jan 2022 00:00:00 GMT"); // Anytime in the past
// }
...
define("PROJECT_LOGO_WHITE_SMALL",        './img/home' . DS . 'x-logo-white.png');
...
define('YEAR_FORMAT',               'Y-m-d');
define('DEFAULT_DATE_FORMAT',       'jS F Y');
define('PRIMARY_DATE_FORMAT',       'j F Y');
define('PASSWORD_RESET_TIME',       '+23 hour +59 minutes');
...
$permissions        = (isset($_SESSION['permissions']) && !empty($_SESSION['permissions'])) ? $_SESSION['permissions'] : NULL;
...
define("STD_COLUMNS" , ["Reference #", "Association Name", "Association Identity", "Client/Applicant's Name", "Tel/Cell Number", "Email"]);
// General Constants
define('TAXRATE',               0.15);
define('SUBSCRIPTION_PERIOD',   "30days");
